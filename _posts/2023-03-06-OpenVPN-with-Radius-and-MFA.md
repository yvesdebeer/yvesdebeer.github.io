...
published: false
---
Setting up a VPN connection to access a remote site can be challenging if you set this up for the first time. In this post I will guide you through the steps to setup an OpenVPN Server and to connect to it using a VPN Client.
